...
import sys
import re
import libs.datas.security as security
from libs.datas.vuln import vuln
...
from libs.utils.smart_fill import smart_fill
...
if __name__ == "__main__":
    ...
    un_url = "http://381679779f2e2c4d870c65f8407bae15.n1.vsgo.cloud:7807/web/vulnerabilities/fi/?page="
    req = Request(un_url)
    vuln_inst = lfi()
    vuln_inst.check(req)
