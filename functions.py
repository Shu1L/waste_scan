...
from libs.commons.common import is_ip_address, get_my_ip
from libs.datas.config import cfg
from libs.datas.info import db_info
from libs.datas.vulnmanager import vm
from libs.utils.process import progress
from libs.utils.mysqlmanager import mm

from facktory   import  factory

from modules.module_subdomain import scan_domain
#from modules.module_portscan import scan_port
from modules.module_finger import scan_finger
from modules.module_dirscan import DirScan
from modules.module_crawler import Crawler
...
class waste_scan:
  ...
  #      self._ps =scan_port()
    ...
    def scan_site(self, target):
        ...
        pthread = _thread.start_new_thread(self.update_progress, ())
    ...
    def scan_dir(self, url, file_list=None):
        ...
        dir_scan2=DirScan.DirScan()
        dir_scan2.scan_dir(urlstr, file_list)
        found_dir = dir_scan2.get_dir_file()
    ...
    def store_vuln(self):
        ...
        # print db_info
        result = base64.b64encode(str(db_info).encode())
        if cfg["remote_mysql"] == True:
